        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Greeting = table.Column<string>(maxLength: 500, nullable: true),
                    ...
                    SendNewTicketTechEmail = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FileDuplicates", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderByNumber = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ButtonCaption = table.Column<string>(maxLength: 50, nullable: true),
                    ForTechsOnly = table.Column<bool>(nullable: false),
                    Name = table.Column<string>(maxLength: 50, nullable: false),
                    StopTimeSpent = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ObjectState = table.Column<string>(nullable: true),
                    UserId = table.Column<string>(maxLength: 128, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SysEventLog", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SysEventLog_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNumberExtension = table.Column<string>(maxLength: 50, nullable: true),
                    Signature = table.Column<string>(maxLength: 2000, nullable: true),
                    UserId = table.Column<string>(maxLength: 128, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ForSpecificUsers = table.Column<bool>(nullable: false),
                    ForTechsOnly = table.Column<bool>(nullable: false),
                    FromAddress = table.Column<string>(maxLength: 255, nullable: true),
                    FromAddressInReplyTo = table.Column<bool>(nullable: false),
                    FromName = table.Column<string>(maxLength: 255, nullable: true),
                    KbOnly = table.Column<bool>(nullable: false),
                    Name = table.Column<string>(maxLength: 250, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedByPerformer = table.Column<bool>(nullable: false),
                    UpdatedByUser = table.Column<bool>(nullable: false),
                    UpdatedForTechView = table.Column<bool>(nullable: false),
                    UserId = table.Column<string>(maxLength: 128, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailHeaders = table.Column<string>(nullable: true),
                    ForTechsOnly = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Subscribers", x => new { x.IssueId, x.UserId });
                    table.ForeignKey(
                        name: "FK_Subscribers_Issues_IssueId",
                        column: x => x.IssueId,
                        principalTable: "Issues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    CommentId = table.Column<int>(nullable: false),
                    DropboxUrl = table.Column<string>(maxLength: 500, nullable: true),
                    FileData = table.Column<byte[]>(nullable: true),
                    FileHash = table.Column<byte[]>(nullable: true),
                    FileName = table.Column<string>(maxLength: 255, nullable: false),
                    FileSize = table.Column<int>(nullable: false),
                    GoogleDriveUrl = table.Column<string>(maxLength: 255, nullable: true),
                    HiddenFromKB = table.Column<bool>(nullable: false),
                    HiddenFromTickets = table.Column<bool>(nullable: false),
                    IssueId = table.Column<int>(nullable: false),
                    UserId = table.Column<string>(maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FileAttachments_Issues_IssueId",
                        column: x => x.IssueId,
                        principalTable: "Issues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FileAttachments_IssueId",
                table: "FileAttachments",
                column: "IssueId");
